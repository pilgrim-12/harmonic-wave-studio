      ...
      {analysisResult ? (
        <div className="flex-1 min-h-0">
          ...
          <div className="mt-2 grid grid-cols-4 gap-2">
            <div className="bg-[#1a1a1a] rounded p-1.5 text-center border border-[#2a2a2a]">
              <div className="text-[9px] text-gray-500">Fundamental</div>
              <div className="text-xs font-bold text-[#667eea]">
                {analysisResult.fundamentalFrequency?.toFixed(2) || "N/A"} Hz
              </div>
            </div>
            <div className="bg-[#1a1a1a] rounded p-1.5 text-center border border-[#2a2a2a]">
              <div className="text-[9px] text-gray-500">Peaks</div>
              <div className="text-xs font-bold text-[#667eea]">
                {analysisResult.peaks.length}
              </div>
            </div>
            <div className="bg-[#1a1a1a] rounded p-1.5 text-center border border-[#2a2a2a]">
              <div className="text-[9px] text-gray-500">THD</div>
              <div className="text-xs font-bold text-[#667eea]">
                {analysisResult.thd.toFixed(1)}%
              </div>
            </div>
            <div className="bg-[#1a1a1a] rounded p-1.5 text-center border border-[#2a2a2a]">
              <div className="text-[9px] text-gray-500">DC Offset</div>
              <div className="text-xs font-bold text-[#667eea]">
